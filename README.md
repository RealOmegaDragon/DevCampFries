...
- Baseline understanding of **HTML structure** and **semantic elements**.
...
- Modular CSS files for components and pages
- Styled buttons, forms, and skewed hero sections
...
- My ability to plan and organize **multi-page site structures**.
- Confidence using **CSS modularization** and naming conventions.
- Understanding of **layout creation** with Flexbox and Grid.
...
| Reusable Components | Nav, footer, buttons, and form styles |
